...
CampusEats is a fullstack web app for browsing campus restaurant menus with food tags and interactive campus maps.
...
- Interactive campus map using Leaflet (react-leaflet)
- Opening hours for Restaurants shown in the UI
- Users can filter menu items by tag using a top-right search bar

- Frontend: React 19, Vite, Tailwind CSS, react-leaflet, leaflet
...
5. Start frontend: `npm run dev` in `frontend/CampusEats/` (default port: 5173)
	- Tailwind CSS and Leaflet are preconfigured in the frontend
